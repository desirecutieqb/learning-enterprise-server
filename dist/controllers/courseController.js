    ...
    try {
        ...
        if (updateData.sections) {
            const sectionsData = typeof updateData.sections === "string"
                ...
                : updateData.sections;
            updateData.sections = sectionsData.map((section) => (Object.assign(Object.assign({}, section), { sectionId: section.sectionId || (0, uuid_1.v4)(), chapters: section.chapters.map((chapter) => (Object.assign(Object.assign({}, chapter), { chaptedId: chapter.chaptedId || (0, uuid_1.v4)() }))) })));
        }
...
const getUploadVideoUrl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!fileName || !fileType) {
        res.status(404).json({ message: "File name and type are required" });
        return;
    }
    try {
